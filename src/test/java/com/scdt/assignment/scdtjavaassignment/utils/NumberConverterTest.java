...
public class NumberConverterTest {
    ...
    public void should_convert_10base_number_to_62base_value(int input, String output) {
    ...
    public void should_convert_62base_value_to_10base_number(String input, int output) {
